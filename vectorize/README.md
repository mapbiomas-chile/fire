...
Merges all regional tiles into **one raster per year**, polygonizes, then groups nearby scars into **multipolygon fire events** when fragments are within **200 m** (configurable).
