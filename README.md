...
- `vectorize/` — Auxiliary pipeline: raster → polygon after filtering. See [vectorize/README.md](vectorize/README.md).
...
- [Vectorize](vectorize/README.md): auxiliary pipeline to polygonize filtered rasters (`vectorize/cluster_paths.env`, then `bash vectorize/run_vectorize_pipeline.sh`).
