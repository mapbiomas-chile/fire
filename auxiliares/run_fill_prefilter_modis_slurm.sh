#!/bin/bash
#---------------Script SBATCH - NLHPC ----------------
# Recover pre-filter burn ∩ buffered MODIS into classification_20260713
#
#   cd ~/fire && git pull
#   mkdir -p ~/logs
...
OUTPUT_DIR="${PREFILTER_MODIS_OUTPUT_DIR:-${HOME}/classification_20260713_prefilter_modis}"
...
echo "============================================="
echo "PREFILTER ∩ buffered MODIS fill — NLHPC"
echo "============================================="
echo "Repo:       ${FIRE_REPO}"
