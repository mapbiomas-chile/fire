#!/bin/bash
#---------------Script SBATCH - NLHPC ----------------
# Recover UNIDOS_13_18 polygons gated by prefilter into classification_20260713
# (2013–2018). Complete polygon fill when ≥1 prefilter pixel touches the scar.
#
#   cd ~/fire && git pull
#   mkdir -p ~/logs
...
echo "============================================="
echo "PREFILTER ∩ UNIDOS complete fill — NLHPC"
echo "============================================="
echo "Repo:       ${FIRE_REPO}"
echo "Layout:     ${LAYOUT}"
